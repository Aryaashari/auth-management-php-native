...
<head>
    ...
    <title>Auth Management - Edit Password</title>
...
<body>
    ...
    <div class="container flex justify-center mt-32">
        ...
        <div class="card w-96 bg-base-50 shadow-xl" data-theme="bumblebee">
            <div class="card-body">
                <h2 class="font-bold text-center text-lg">Edit Password</h2>
                ...
                <form action="/profile/update" method="POST" class="w-full">
                    <div class="form-control mb-3">
                        ...
                        <label class="input-group">
                            ...
                            <input type="password" name="oldPassword" class="input input-bordered w-full" />
                        </label>
                    </div>
                    ...
                    <div class="form-control mb-3">
                        <label class="input-group">
                            ...
                            <input type="password" name="confirmNewPassword" class="input input-bordered w-full" />
                        </label>
                    </div>
